...
import thumbnail from '../assets/images/bob.png'
	...
	return (
		<div className={pageStatus ? styles.about_dark : styles.about}>
			<div className={styles.about}>
				<h2 className={pageStatus ? styles.aboutTitle_dark : styles.aboutTitle}>ABOUT ME</h2>
